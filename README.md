...
| `ANDROID_PACKAGE_NAME` | Package name emitted in `/.well-known/assetlinks.json`. Defaults to `com.growthproject.app`; override only if a separate Play build is used. | `com.growthproject.app` |
