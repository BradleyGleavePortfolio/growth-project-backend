...
-- 20261220000000 is strictly AFTER the latest landed migration
-- (20261219000000_*) so the ordered apply never reorders behind a shipped
-- migration (migrations are append-only).
--
