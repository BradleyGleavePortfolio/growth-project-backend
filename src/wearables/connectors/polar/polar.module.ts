 ...
 * editing that file, this module CONTRIBUTES its {@link polarConnectorDef} by
...
@Module({
  ...
  providers: [
    ...
    IngestionService,
    PolarConnector,
    // Registry contribution: bind Polar's canonical ConnectorDefinition VALUE to
    ...
    { provide: WEARABLE_CONNECTORS, useValue: polarConnectorDef },
  ],
