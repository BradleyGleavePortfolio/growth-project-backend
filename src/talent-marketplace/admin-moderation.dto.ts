// TM-7 — Admin moderation DTOs (owner-only listing + applicant review).
...
export class ReviewQueueQueryDto {
  ...
  // Listing queue: draft | published | closed. Application queue: submitted |
  // screening | shortlisted | offered | placed | rejected | withdrawn. Validated
  // loosely here; the service pins it to the row's own enum.
  @IsOptional()
  @IsString()
  @MaxLength(40)
  status?: string;
