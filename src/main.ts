...
async function bootstrap() {
  ...
  app.useGlobalFilters(
    ...
    // H6 (D-H6-2): CircuitOpenFilter maps CircuitOpenError -> 503 + Retry-After: 30.
    // Registered last so Nest's dispatch (most-specific @Catch wins) routes
    // CircuitOpenError here before the catch-all HttpExceptionFilter.
