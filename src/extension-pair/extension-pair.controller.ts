...
export class ExtensionPairController {
  ...
  @ApiResponse({
    status: 410,
    description:
      'Challenge unavailable. Read current with saved setup_nonce to recover the owned intent.',
  ...
  @ApiOperation({
    ...
    description:
      'Empty body reads current setup; saved setup_nonce reads that exact owned attempt. ' +
