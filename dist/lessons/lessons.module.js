...
exports.LessonsModule = LessonsModule = __decorate([
    (0, common_1.Module)({ imports: [auth_module_1.AuthModule], controllers: [lessons_controller_1.LessonsController], providers: [lessons_service_1.LessonsService, prisma_service_1.PrismaService] })
], LessonsModule);
