...
export declare class LogService {
    ...
    getDaily(userId: string, date: string): Promise<{
        date: string;
        entries: ({
            food_item: {
                id: string;
    ...
    updateEntry(userId: string, entryId: string, data: any): Promise<{
        id: string;
        user_id: string;
        date: Date;
        meal_type: import(".prisma/client").$Enums.MealType;
    ...
    getWeekly(userId: string, weekStart: string): Promise<any[]>;
}
