...
exports.HabitsModule = HabitsModule = __decorate([
    (0, common_1.Module)({ imports: [auth_module_1.AuthModule], controllers: [habits_controller_1.HabitsController], providers: [habits_service_1.HabitsService, prisma_service_1.PrismaService] })
], HabitsModule);
