...
exports.CoachModule = CoachModule = __decorate([
    (0, common_1.Module)({ imports: [auth_module_1.AuthModule], controllers: [coach_controller_1.CoachController], providers: [coach_service_1.CoachService, prisma_service_1.PrismaService] })
], CoachModule);
