...
export declare class CoachService {
    ...
    getClients(coachId: string): Promise<({
        profile: {
            id: string;
            user_id: string;
    ...
    getClientTimeline(coachId: string, clientId: string, days?: number): Promise<{
        error: string;
        client?: undefined;
        meals?: undefined;
        workouts?: undefined;
    ...
    postGuidelines(coachId: string, clientId: string, guidelines: string): Promise<{
        id: string;
        coach_id: string;
        created_at: Date;
        tags: string[];
    ...
    getGuidelines(coachOrClientId: string, clientId?: string): Promise<{
        id: string;
        coach_id: string;
        created_at: Date;
        tags: string[];
    ...
    getClientSummary(coachId: string, clientId: string, date?: string): Promise<{
        error: string;
        profile?: undefined;
    ...
    getAlerts(coachId: string): Promise<any[]>;
}
