...
const LEGACY_GUARD_ALLOWLIST: Array<{
  ...
  { controller: 'CoachController', method: 'getRiskBoard', reason: 'CoachGuard at class level' },
  ...
  { controller: 'CoachController', method: 'upsertGuidelines', reason: 'CoachGuard at class level' },
  { controller: 'CoachController', method: 'getAlerts', reason: 'CoachGuard at class level' },
  // ── CoachCheckInsController ──
  { controller: 'CoachCheckInsController', method: 'getClientCheckIns', reason: 'CoachGuard at class level' },
  // ── CoachMessagingController ──
  { controller: 'CoachMessagingController', method: 'getClientMessages', reason: 'CoachGuard at class level' },
  { controller: 'CoachMessagingController', method: 'sendClientMessage', reason: 'CoachGuard at class level' },
  { controller: 'CoachMessagingController', method: 'uploadClientVoice', reason: 'CoachGuard at class level' },
  { controller: 'CoachMessagingController', method: 'markClientMessagesRead', reason: 'CoachGuard at class level' },
  { controller: 'CoachMessagingController', method: 'getUnreadCount', reason: 'CoachGuard at class level' },
  // ── CoachNudgesController ──
  { controller: 'CoachNudgesController', method: 'sendNudge', reason: 'CoachGuard at class level' },
  // ── CoachMealPlansController ──
  { controller: 'CoachMealPlansController', method: 'getClientMealPlans', reason: 'CoachGuard at class level' },
  { controller: 'CoachMealPlansController', method: 'createMealPlan', reason: 'CoachGuard at class level' },
  { controller: 'CoachMealPlansController', method: 'updateMealPlan', reason: 'CoachGuard at class level' },
  { controller: 'CoachMealPlansController', method: 'deleteMealPlan', reason: 'CoachGuard at class level' },
  // ── CoachBuildWeekController ──
  { controller: 'CoachBuildWeekController', method: 'getClientBuildWeek', reason: 'CoachGuard at class level' },
  // ── CoachAlertsController ──
  { controller: 'CoachAlertsController', method: 'getAlerts', reason: 'CoachGuard at class level' },
  { controller: 'CoachAlertsController', method: 'acknowledgeAlert', reason: 'CoachGuard at class level' },
  // ── CoachOnboardingController ──
  { controller: 'CoachOnboardingController', method: 'getProgress', reason: 'CoachGuard at class level' },
  { controller: 'CoachOnboardingController', method: 'start', reason: 'CoachGuard at class level' },
  { controller: 'CoachOnboardingController', method: 'completeStep', reason: 'CoachGuard at class level' },
  ...
  { controller: 'InviteCodesController', method: 'createInviteCode', reason: 'Per-handler JwtAuthGuard+CoachGuard' },
  { controller: 'InviteCodesController', method: 'listInviteCodes', reason: 'Per-handler JwtAuthGuard+CoachGuard' },
  { controller: 'InviteCodesController', method: 'deleteInviteCode', reason: 'Per-handler JwtAuthGuard+CoachGuard' },
  { controller: 'InviteCodesController', method: 'getInviteLink', reason: 'Per-handler JwtAuthGuard+CoachGuard' },
  { controller: 'InviteCodesController', method: 'regenerateInviteLink', reason: 'Per-handler JwtAuthGuard+CoachGuard' },
  ...
  { controller: 'CoachBillingController', method: 'getBillingStatus', reason: 'CoachOrOwnerGuard at class level' },
  { controller: 'CoachBillingController', method: 'createPortalSession', reason: 'CoachOrOwnerGuard at class level' },
  { controller: 'MobileCoachBillingController', method: 'getStatus', reason: 'CoachOrOwnerGuard at class level' },
  { controller: 'MobileCoachBillingController', method: 'createPortalSession', reason: 'CoachOrOwnerGuard at class level' },
  ...
  { controller: 'V1CoachController', method: 'getProfile', reason: 'CoachOrOwnerGuard at class level' },
  { controller: 'V1CoachController', method: 'getClients', reason: 'CoachOrOwnerGuard at class level' },
  { controller: 'V1CoachController', method: 'getThreads', reason: 'CoachOrOwnerGuard at class level' },
